...
`{fedupShiny}` is an R Shiny implementation of the Bioconductor `{fedup}` package
developed with the `{golem}` framework.
Source code can be found [here](https://github.com/rosscm/fedup).
